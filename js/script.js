                ...
                <ul class="navMenu ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="navLi">
                    ...
                    <ul class="dropdownList">
                      <li class="navLi">
                        <a href="#" class="navLink">Service1</a>
                      </li>
                      <li class="navLi">
...
Main Road, Vadodara,391410
      ...
      <div class="col-12">
      <div class="inner">
      <div class="copyright text-center"> <span class="year"></span>  All Rights Reserved by EVENTFUL | Developed by <a href="https://shriiitrackingsolution.in/" target="_blank">
    ...
    <div class="fab-container">
      <a class="set-url-target" rel="noopener" data-mobile-target="" data-desktop-target="_blank" target="_blank" href="https://api.whatsapp.com/send?phone=number">
